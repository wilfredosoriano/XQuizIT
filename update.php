...
$desc = $_POST['desc'];
$id=uniqid();
$q3=mysqli_query($con,"INSERT INTO quiz VALUES  ('$id','$name' , '$cor' , '$wrong','$total','$time' ,'$desc','$tag', NOW())");
...
$r++;
$s=$s+$cor;
$q=mysqli_query($con,"UPDATE `history` SET `score`=$s,`level`=$sn,`cor`=$r, date= NOW()  WHERE  email = '$email' AND eid = '$eid'")or die('Error124');
